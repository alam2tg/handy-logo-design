...
class Triangle extends Shape {
	...
	render() {
		return `<polygon width="200" height="200" points="50,200 250,200 150,0" fill="${this.color}"/><text x="150" y="140" font-size="50" text-anchor="middle" fill="${this.textColor}">${this.text}</text>`
	}
}
